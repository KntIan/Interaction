<template>
  <view class="login-container">
    <view class="logo">
      <image src="@/static/images/bg.png" mode="aspectFit" />
    </view>
    <view class="input-group">

      <view class="input-container">
        <image src="@/static/images/Frame 2218.png" class="icon" mode="aspectFit"></image>
        <text class="country-code">+86</text>
        <input class="input-field" type="text" placeholder="请输入手机号" />
      </view>
      <!-- <view style="display: flex; align-items: center; gap: 5px">
        <image src="@/static/images/vuesaxlinearshield-tick.png" style="width: 24px; height: 24px"></image>
        <text>验证码</text>
      </view>
      ...
      <view class="input-container">
        <image src="@/static/images/vuesaxlinearshield-tick.png" class="icon" mode="aspectFit"></image>
        <input class="input-field" type="text" placeholder="请输入验证码" />
        <view @click.stop="sendVerificationCode" :disabled="isCodeSent" :class="{ 'code-button': true, 'disabled-button': isCodeSent }">
...
.country-code {
  margin-right: 5px; /* 国家代码与输入框之间的间距 */
}
