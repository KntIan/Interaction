<template>
  <view class="my_box">
    ...
    <view class="info">
      <view class="item"><label>公司</label><text>{{info}}</text></view>
      <view class="item"><label>职位</label><text>公司</text></view>
      <view class="item"><label>地址</label><text>公司</text></view>
    </view>
  </view>
</template>
...
import { getMyPage } from '@/utils/api'
