  ...
  <view class="container">
    ...
    <view v-if="showToast" class="custom-toast">
      ...
      <view class="toast-content">
        ...
        <view class="logs_box">
          <view class="item" v-for="item in radioOptions" :key="item.value" :class="{ 'selected': selectedValue === item.value }">
            ...
            <input type="radio" :value="item.value" v-model="selectedValue" @click="onRadioChange(item.value)" :checked="item.checked" />
          </view>
        </view>
...
.selected {
  ...
  background-color: rgba(76, 175, 80, 0.1); /* 设置背景色 */
