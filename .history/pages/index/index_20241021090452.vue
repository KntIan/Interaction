      ...
      <view class="toast-content">
        ...
        <view class="logs_box">
          <view class="item" v-for="item in radioOptions">
            ...
            <image style="width: 24px; height: 24px; margin: auto; padding-bottom: 10px;" :src="item.isSelected ? '@/static/images/iconis.png' : '@/static/images/iconno.png'" @click="changeIcon(item)" />
          </view>
        </view>
