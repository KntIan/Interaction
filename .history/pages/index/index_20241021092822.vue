...
const changeBackgroundImage = (item) => {
  ...
  if (item.bgImage === '/h5/static/images/iconno.png') {
    item.bgImage = '/h5/static/images/iconnois.png'; // 切换到另一个背景
  } else {
    item.bgImage = '/h5/static/images/iconno.png'; // 切换回默认背景
  }
  console.log('切换背景图片:', item.bgImage);
  console.log('切换背景图片:', radioOptions);
};
const closeToast = () => {
