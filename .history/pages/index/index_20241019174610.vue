      ...
      <view class="toast-content">
        ...
        <view class="logs_box">
          <view class="item" v-for="item in radioOptions">
            ...
            <image style="width: 24px; height: 24px; margin: auto; padding-bottom: 10px;" :src="isChange ? '/static/images/iconno.png' : '/static/images/iconis.png'" @click="changeIcon()=>{isChange = !isChange}" />
          </view>
        </view>
...
const isChange = ref(false); // 初始化打卡状态
