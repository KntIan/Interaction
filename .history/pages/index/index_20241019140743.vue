...
onMounted(async () => {
  ...
  if (param) {
    try {
      ...
      // 提取is_point和产品信息并更新状态
      isCheckedIn.value = response.data.is_point;
      ...
      console.log(attendanceStore.setLogs([...attendanceStore.logs, { is_point: isCheckedIn.value, product: productInfo.value }]))
      // 检查打卡状态，如果全部为已打卡，则弹窗提醒
