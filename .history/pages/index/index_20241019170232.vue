      ...
      <view class="toast-content">
        ...
        <view class="logs_box">
          <view class="item" v-for="item in radioOptions">
            ...
            <image style="width: 24px; height: 24px; margin: auto; padding-bottom: 10px;" :src="icon.valueOf" mode="scaleToFill" @click="changeIcon(item)" />
          </view>
        </view>
...
const icon = ref("@/static/images/iconno.png");
