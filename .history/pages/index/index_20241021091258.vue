      ...
      <view class="toast-content">
        ...
        <view class="logs_box">
          <view class="item" v-for="item in radioOptions">
            ...
            <view class="bg_img">
              <im style="width: 24px; height: 24px; margin: auto; padding-bottom: 10px;" :src="item.checked ? '../../static/images/iconis.png' : '../../static/images/iconno.png'" @click="changeIcon(item)" />
            </view>
          </view>
        </view>
